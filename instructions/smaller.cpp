...
Smaller::Smaller(uint16_t input1_pointer, uint16_t input2_pointer, uint16_t output_pointer) :
...
void Smaller::operator()(std::vector<float>& memory, uint8_t& subprogram_pointer,
